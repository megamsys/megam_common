...
class AccountsSpec extends Specification {
  ...
  case object Post extends Context {
    ...
    protected override def bodyToStick: Option[String] = {
      // "{\"name\":\"Darth\", \"last_name\":\"Vader\", \"phone\":\"19090909090\", \"email\":\"rr@test.com\", \"api_key\":\"IamAtlas{74}NobodyCanSeeME#07\", \"password\":\"user\", \"authority\":\"user\", \"password_reset_key\":\"user\",\"password_reset_sent_at\":\"\" }"
        val contentToEncode = "{" +
          "\"name\":{" +
        "\"first_name\":\"Darth\"," +
        "\"last_name\":\"Vader\"" +
