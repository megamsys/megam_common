        ...
        try {
          ...
          case _: InterruptedException =>
            ...
            logger.log(Level.FINE,
              "io.megam.util.Closable collector thread caught InterruptedException")

          case NonFatal(exc) =>
            logger.log(Level.SEVERE,
              "io.megam.util.Closable collector thread caught exception", exc)

          case fatal: Throwable =>
            logger.log(Level.SEVERE,
              "io.megam.util.Closable collector thread threw fatal exception", fatal)
            throw fatal
        }
      }
    }
