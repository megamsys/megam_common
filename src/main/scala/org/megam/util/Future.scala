 ...
 *
 */
import org.megam.concurrent.{Offer, Scheduler, Tx}
...
object Future {
   ...
   * It will catch nonfatal (see: [[org.megam.util.NonFatal]])
 ...
 *
 * Futures are also [[org.megam.util.Cancellable]], but with
...
abstract class Future[+A] extends Awaitable[A] {
  import org.megam.util.Future.DEFAULT_TIMEOUT
...
private[util] object FutureBenchmark {
  ...
  import org.megam.conversions.storage._
